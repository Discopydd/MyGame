...
/// <summary>
/// 3Dオブジェクトの色、ライティング設定、UV変換情報を保持する構造体。
/// </summary>
struct Material
{
    float32_t4 color;
...
/// <summary>
/// ピクセルシェーダーで使用する平行光源の色、方向、明るさを保持する構造体。
/// </summary>
...
/// <summary>
/// ピクセルシェーダーで使用するカメラのワールド座標を保持する構造体。
/// </summary>
struct Camera
{
...
/// <summary>
/// ピクセルシェーダーで使用する点光源の色、位置、明るさ、減衰情報を保持する構造体。
/// </summary>
struct PointLight
{
    float32_t4 color;
...
/// <summary>
/// ピクセルシェーダーで使用するスポットライトの色、位置、方向、照射範囲を保持する構造体。
/// </summary>
struct SpotLight
{
    float32_t4 color;
...
/// <summary>
/// 3Dオブジェクト用ピクセルシェーダーが出力する最終色を保持する構造体。
/// </summary>
